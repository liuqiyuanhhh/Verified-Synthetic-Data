...
class CVAE(nn.Module):
    def __init__(self, input_dim=784, label_dim=10, latent_dim=20):
        ...
        self.encoder = Encoder(input_dim+label_dim, hidden_dim=400, latent_dim=latent_dim)
        self.decoder = Decoder(latent_dim+label_dim, hidden_dim=400, output_dim=input_dim)
    ...
    def sample_x_given_y(self, y, num_samples):
        ...
        y_tensor = torch.full((num_samples,), y, dtype=torch.long, device=device)
