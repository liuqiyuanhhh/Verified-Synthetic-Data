...
ROOT = f"/home/qiyuanliu/data_filter/Verified-Synthetic-Data/MNIST/conv_cvae/dic_{FIXED}"
...
for round_id in range(1, k + 1):
    ...
    discriminator_dataset = data_helper.prepare_discriminator_dataset(full_dataset, curr_model, num_samples=FIXED, device=device)
